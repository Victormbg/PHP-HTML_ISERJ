...
<form name= "frmenta" method="post" action="script.php" /> 
<center>
...
<td>
<button type"submit" name="btn1" value="subi">MULTIPLICAÇÃO</button>
</td>
<td>
<button type"submit" name="btn1" value="subi">DIVISÃO</button>
</td>
<td>
